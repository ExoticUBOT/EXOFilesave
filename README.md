...
**If you need any more modes in repo or If you find out any bugs, mention in [@Exo_URobot](https://www.telegram.dog/EXO_URobot)**
...
#### Deploy in your VPS
````bash
git clone https://github.com/ExoticUBOT/EXOFilesave
cd File-Sharing-Bot
